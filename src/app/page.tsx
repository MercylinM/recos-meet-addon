...
export default function SidePanel() {
  ...
  useEffect(() => {
    const initializeAddon = async () => {
      try {
        ...
        // Auto-connect to transcript stream
  ...
  // Connect to transcript WebSocket from bot backend
    ...
    transcriptWebSocket.current.onmessage = (event) => {
      try {
        ...
        if (messageType === 'interim_transcript') {
          // Handle interim transcripts from bot
          ...
          setTranscripts((prev) => {
            // Replace existing interim transcript
          ...
          // Handle final transcripts from bot
          ...
          // Handle AI-analyzed transcripts from bot
  ...
  // Start bot session (optional - if you want the add-on to trigger the bot)
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#141244] to-[#1a1458] text-white p-6">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <Card title="Bot Controls" glowing={isConnected}>
            <div className="space-y-4">
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-3">
                <div className="text-blue-300 font-medium text-sm mb-1">External Bot Processing</div>
                <div className="text-white/70 text-xs">
                  Audio is captured by an external bot and processed through the backend.
                  This add-on displays real-time transcripts and AI analysis.
                </div>
              </div>
        ...
        <div className="mt-8 text-center text-white/40 text-sm">
          <p>Powered by external bot processing, Google Speech API, Gemini AI</p>
          <p className="mt-1">Audio captured by bot → Processed by backend → Displayed in add-on</p>
        </div>
      </div>
